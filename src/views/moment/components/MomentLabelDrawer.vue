  ...
  <el-drawer v-model="drawerVisible" :destroy-on-close="true" size="450px" :title="`${drawerProps.title}文章`">
    ...
    >
      <el-form-item label="标签名" prop="title">
        <el-input v-model="drawerProps.row!.name" placeholder="标签名" clearable></el-input>
      </el-form-item>
    </el-form>
    <template #footer>
...
import { ArticleLabel } from "@/api/interface";
...
interface DrawerProps {
  title: string;
  isView: boolean;
  row: Partial<ArticleLabel.ResArticleLabelList>;
