  ...
  <el-drawer v-model="drawerVisible" :destroy-on-close="true" size="450px" :title="`${drawerProps.title}菜单`">
    ...
    >
      <el-form-item label="权限名" prop="name">
        <el-input v-model="drawerProps.row!.name" placeholder="权限名" clearable></el-input>
      </el-form-item>
      <el-form-item label="权限描述" prop="desc">
        <el-input v-model="drawerProps.row!.desc" placeholder="权限描述" clearable></el-input>
      </el-form-item>
    </el-form>
    <template #footer>
...
import { Permissions } from "@/api/interface";
...
interface DrawerProps {
  title: string;
  isView: boolean;
  row: Partial<Permissions.ResPermissionList>;
